...
Replacing NAN with out of the feature value range (mean, median, most frequent)

8. What is the multivariate imputation method in sklearn?
Constuction of the NAN with use of other variables.

9. What is the best univariate imputation method to categorical variables? (Explain why)
XGBoost and Multivariate. 
...
Point that significally different from other datapoints
